  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-sky-50 to-teal-50 flex flex-col items-center justify-center p-6">
      ...
      <div className="mt-5 flex flex-wrap items-center justify-center gap-x-4 gap-y-2 text-xs text-gray-500">
        <button onClick={() => navigate("/legal/terms")} className="hover:text-gray-900">Terms</button>
        <button onClick={() => navigate("/legal/privacy")} className="hover:text-gray-900">Privacy</button>
        <button onClick={() => navigate("/legal/medical")} className="hover:text-gray-900">Medical Disclaimer</button>
        <button onClick={() => navigate("/legal/emergency")} className="hover:text-gray-900">Emergency</button>
      </div>
    </div>
  );
}
