...
const validateRegistrationStart = async (req, res) => {
  try {
    const { name, email, password, phone, role, specializations, experience, gender } = req.body;
...
const register = async (req, res) => {
  try {
    const { name, email, password, phone, role, address, city, experience, gender, interviewAnswers, interviewQuestions } = req.body;
