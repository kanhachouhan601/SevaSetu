...
const { errorHandler, notFound, requestContext, requestLogger, securityHeaders } = require('./src/middleware/error.middleware');
...
app.use(rateLimit({ windowMs: 60 * 1000, max: 240, scope: 'global' }));
